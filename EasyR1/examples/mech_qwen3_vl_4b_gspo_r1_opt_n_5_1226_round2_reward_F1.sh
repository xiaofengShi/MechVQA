...
EXP_NAME=${1:-mechvlmv2-vqa-4b_gspo_rollout_10_data_1226_round2_rolln5_ep3_reward_f1}
...
python3 -m verl.trainer.main \
    ...
    worker.reward.reward_function="./examples/reward_function/mech_diverse_F1.py:compute_score" \
