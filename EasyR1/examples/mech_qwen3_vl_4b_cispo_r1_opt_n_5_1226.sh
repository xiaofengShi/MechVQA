...
EXP_NAME=${1:-mechvlmv2-vqa-4b_cispo_rollout_10_data_1226}
...
python3 -m verl.trainer.main \
    ...
    data.train_files=data/train_1226_.json \
    data.val_files=data/val_1226_.json \
    ...
    worker.reward.reward_function="./examples/reward_function/mech_diverse.py:compute_score" \
