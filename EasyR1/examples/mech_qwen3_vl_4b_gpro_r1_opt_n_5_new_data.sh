...
EXP_NAME=${1:-qwen3_vl_4b_mech_sft_reasoning_cooling_and_gpro_roolout_n_5_data_v251114}
...
python3 -m verl.trainer.main \
    ...
    data.train_files=data/train_1114_.json \
    data.val_files=data/eval_1114_.json \
