...
EXP_NAME=${1:-mechvlmv2-vqa-4b_dapo_rollout_10_data_1226_round2_rolln10_ep10_w_judge_case2}
...
python3 -m verl.trainer.main \
    ...
    worker.reward.reward_function="./examples/reward_function/mech_diverse_case2.py:compute_score" \
